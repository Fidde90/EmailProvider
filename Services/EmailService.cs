    ...
    public class EmailService : IEmailService
    {
        ...
        public EmailRequest UnPackEmailRequest(ServiceBusReceivedMessage message)
        {
            try
            {
                ...
                if (emailRequest != null) return emailRequest;
            }
            catch (Exception ex) { _logger.LogError($"Error : EmailSender.UnPackEmailRequest() :: {ex.Message}"); }
        ...
        public bool SendEmail(EmailRequest emailRequest)
        {
            ...
            catch (Exception ex) { _logger.LogError($"Error : SendEmailAsync() :: {ex.Message}"); }
            return false;
        }
    }
}
